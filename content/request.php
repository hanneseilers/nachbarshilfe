	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-8">
				...
				<div class="">
					<div class="col-md-12 bg-danger text-light p-2">
						<h3><i class="fas fa-hands-helping fa-fw"></i> Hilfe anfragen</h3>
					</div>
			...
			<div class="col-md-4">
				<p>
					<a href="javascript: addRequest();"><button class="btn btn-lg btn-danger"><i class="fas fa-plus"></i> Hilfe anfragen</button></a>
				</p>
				<p>
